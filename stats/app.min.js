...
}).left;return function(p,v,nf){if(prior)prior(p,v,nf);i=bisect(path(p).valueList,a(v),0,path(p).valueList.length);path(p).valueList.splice(i,1);return p}},initial:function(prior,path){return function(p){p=prior(p);path(p).valueList=[];return p}}};module.exports=reductio_value_list},{crossfilter:5}],32:[function(require,module,exports){"use strict";Highcharts.theme={colors:["#B34C3C","#2b908f","#90ee7e","#f45b5b","#7798BF","#aaeeee","#ff0066","#eeaaee","#55BF3B","#DF5353","#7798BF","#aaeeee"],chart:{backgroundColor:"#1d1f21",plotBorderColor:"#606063"},title:{style:{color:"#c5c8c6",fontSize:"20px"}},xAxis:{gridLineColor:"#707073",labels:{style:{color:"#c5c8c6"}},lineColor:"#707073",minorGridLineColor:"#505053",tickColor:"#707073",title:{style:{color:"#c5c8c6"}}},yAxis:{gridLineColor:"#707073",labels:{style:{color:"#c5c8c6"}},lineColor:"#707073",minorGridLineColor:"#505053",tickColor:"#707073",tickWidth:1,title:{style:{color:"#A0A0A3"}}},tooltip:{backgroundColor:"rgba(0, 0, 0, 0.85)",style:{color:"#c5c8c6"},pointFormat:'<span style="color:{point.color}">●</span> {series.name}: <b>{point.y:,.2f}</b><br/>'},plotOptions:{series:{dataLabels:{color:"#B0B0B3"},marker:{lineColor:"#333"}},boxplot:{fillColor:"#505053"},candlestick:{lineColor:"white"},errorbar:{color:"white"}},legend:{itemStyle:{color:"#E0E0E3"},itemHoverStyle:{color:"#FFF"},itemHiddenStyle:{color:"#606063"}},credits:{style:{color:"#666"}},labels:{style:{color:"#707073"}},drilldown:{activeAxisLabelStyle:{color:"#F0F0F3"},activeDataLabelStyle:{color:"#F0F0F3"}},navigation:{buttonOptions:{symbolStroke:"#DDDDDD",theme:{fill:"#505053"}}},rangeSelector:{buttonTheme:{fill:"#505053",stroke:"#000000",style:{color:"#CCC"},states:{hover:{fill:"#707073",stroke:"#000000",style:{color:"white"}},select:{fill:"#000003",stroke:"#000000",style:{color:"white"}}}},inputBoxBorderColor:"#505053",inputStyle:{backgroundColor:"#333",color:"silver"},labelStyle:{color:"silver"}},navigator:{handles:{backgroundColor:"#666",borderColor:"#AAA"},outlineColor:"#CCC",maskFill:"rgba(255,255,255,0.1)",series:{color:"#7798BF",lineColor:"#A6C7ED"},xAxis:{gridLineColor:"#505053"}},scrollbar:{barBackgroundColor:"#808083",barBorderColor:"#808083",buttonArrowColor:"#CCC",buttonBackgroundColor:"#606063",buttonBorderColor:"#606063",rifleColor:"#FFF",trackBackgroundColor:"#404043",trackBorderColor:"#404043"},legendBackgroundColor:"rgba(0, 0, 0, 0.5)",background2:"#505053",dataLabelsColor:"#B0B0B3",textColor:"#C0C0C0",contrastTextColor:"#F0F0F3",maskColor:"rgba(255,255,255,0.3)"};Highcharts.setOptions(Highcharts.theme)},{}],33:[function(require,module,exports){"use strict";var _d=require("d3");var _d2=_interopRequireDefault(_d);var _crossfilter=require("crossfilter2");var _crossfilter2=_interopRequireDefault(_crossfilter);require("./highcharts_theme");var _reductio=require("reductio");var _reductio2=_interopRequireDefault(_reductio);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{"default":obj}}var dsv=_d2.default.dsv(";","text/csv");var games=["G1","G2","G3","G4","G5","G6"];var avgDescending=function avgDescending(a,b){return _d2.default.descending(a.value.avg,b.value.avg)};function avgAll(all){return all.filter(function(d){return d.value.avg!==0}).sort(avgDescending)}var cf=void 0,allAvg=void 0,allGames=void 0,playerDim=void 0,countryDim=void 0,disciplineDim=void 0,handDim=void 0,genderDim=void 0,genderDim2=void 0,allDim=void 0,playerGrp=void 0,countryGrp=void 0,disciplineGrp=void 0,handGrp=void 0,genderGrp=void 0,genderGameGrp=void 0,allGrp=void 0,gameGrp=void 0,minGrp=void 0,maxGrp=void 0,avgGrp=void 0,totalGrp=void 0,playerChart=void 0,countryChart=void 0,disciplineChart=void 0,genderChart=void 0,handChart=void 0,gameChart=void 0;function scoreReducer(group){group.reduce(function(p,v){games.forEach(function(g){var gScore=+v[g];if(gScore>0){++p.count;p.sum+=gScore;p.avg=p.sum/p.count||0}});return p},function(p,v){games.forEach(function(g){var gScore=+v[g];if(gScore>0){--p.count;p.sum-=gScore;p.avg=p.sum/p.count||0}});return p},function(p,v){return{count:0,sum:0,avg:0}});return{all:function all(){return group.all().filter(function(d){return d.value.sum!==0})}}}function initFilters(chart,dim){var _filters=chart.filters=[];chart.hasFilter=function(key){if(!arguments.length){return!!_filters.length}return!!~_filters.indexOf(key)};chart.filter=function(key){if(chart.hasFilter(key)){_filters.splice(_filters.indexOf(key),1)}else{_filters.push(key)}if(_filters.length===0){dim.filter(null)}else if(_filters.length===1){dim.filterExact(_filters[0])}else{dim.filterFunction(function(d){for(var i=0;i<_filters.length;++i){var filter=_filters[i];if(filter<=d&&filter>=d){return true}}return false})}}}function initAverageChart(dimension,group,options){var _all=avgAll(group.all());var chart=new Highcharts.chart({chart:{type:options.type||"bar",renderTo:options.renderTo,height:options.height},plotOptions:{bar:{cursor:"pointer",point:{events:{click:function click(e){chart.filter(this.category);updateAll()}}}}},title:{text:options.title},xAxis:{categories:_all.map(function(d){return d.key}),title:{text:null}},yAxis:{min:0,title:{text:"Average"},labels:{overflow:"justify"}},legend:{enabled:false},series:[{name:"Average",data:_all.map(function(d){return d.value.avg})}]});initFilters(chart,dimension);return chart}function updateAverageChart(chart,group){var redraw=arguments.length<=2||arguments[2]===undefined?true:arguments[2];var _all=avgAll(group.all());var _keys=_all.map(function(d){return d.key});var _values=_all.map(function(d){return{y:d.value.avg,color:getColor(chart,d)}});chart.xAxis[0].setCategories(_keys,false);chart.series[0].setData(_values,redraw)}function initPlayerChart(){var _playerAll=avgAll(playerGrp.all());playerChart=initAverageChart(playerDim,playerGrp,{renderTo:document.getElementById("playerChart"),title:"Player Averages",height:19*_playerAll.length+182})}function getColor(chart,d){return!chart.hasFilter()?undefined:chart.hasFilter(d.key)?undefined:"#333"}function updatePlayerChart(){if(!playerChart)return initPlayerChart();var _playerAll=avgAll(playerGrp.all());updateAverageChart(playerChart,playerGrp,false);playerChart.setSize(playerChart.chartWidth,19*_playerAll.length+playerChart.marginBottom*2)}function initGameChart(){var _all=genderGameGrp.all();var _categories=Object.keys(_all[0].value);gameChart=new Highcharts.Chart({chart:{renderTo:document.getElementById("playerGameChart"),type:"line"},title:{text:"Game Averages"},xAxis:{categories:_categories,title:{text:null}},yAxis:{min:0,title:{text:"Average"},labels:{overflow:"justify"}},series:_all.map(function(d,i){return{name:d.key+" Average",data:Object.keys(d.value).map(function(k){return d.value[k].avg}),color:Highcharts.theme.colors[i+1]}})})}function updateGameChart(){if(!gameChart)return initGameChart();var scaleRange=[];disciplineGrp.all().forEach(function(d){scaleRange=scaleRange.concat(games.map(function(g){return d.key+": "+g}))});var _all=gameGrp.all();gameChart.xAxis[0].setCategories(scaleRange,false);var data=_all.map(function(d){return d.value.avg});if(data.join("")===allAvg.map(function(d){return d.value.avg}).join("")){gameChart.series[2].remove(true);return}if(gameChart.series[2]){gameChart.series[2].setData(data)}else{gameChart.addSeries({name:"Filter Average",data:data,color:Highcharts.theme.colors[0]})}}function initCountryChart(){var _all=avgAll(countryGrp.all());countryChart=initAverageChart(countryDim,countryGrp,{renderTo:document.getElementById("countryChart"),height:20*_all.length,title:"Country Averages"})}function updateCountryChart(){if(!countryChart)return initCountryChart();updateAverageChart(countryChart,countryGrp)}function initGenderChart(){genderChart=initAverageChart(genderDim,genderGrp,{renderTo:document.getElementById("genderChart"),title:"Gender Averages"})}function updateGenderChart(){if(!genderChart)return initGenderChart();updateAverageChart(genderChart,genderGrp)}function initDisciplineChart(){disciplineChart=initAverageChart(disciplineDim,disciplineGrp,{renderTo:document.getElementById("disciplineChart"),title:"Discipline Averages"})}function updateDisciplineChart(){if(!disciplineChart)return initDisciplineChart();updateAverageChart(disciplineChart,disciplineGrp)}function initHandChart(){handChart=initAverageChart(handDim,handGrp,{renderTo:document.getElementById("handChart"),title:"Hand Averages"})}function updateHandChart(){if(!handChart)return initHandChart();updateAverageChart(handChart,handGrp)}var format=_d2.default.format(".0f");function numberContainer(accessor,selection,description){var _value=accessor();var _el=_d2.default.select(selection);var _sel=_el.selectAll(".number").data([_value]);_sel.enter().append("span").attr("class","number").text(0);_sel.enter().append("span").attr("class","description").text(description);_sel.exit().remove();_el.selectAll(".number").transition().duration(375).tween("text",function(d){var i=_d2.default.interpolate(this.textContent,d);return function(t){this.textContent=format(i(t))}})}function updateNumbers(){numberContainer(function(){return minGrp.all()[0].value.min},"#lowGame","Low");numberContainer(function(){return maxGrp.all()[0].value.max},"#highGame","High");numberContainer(function(){return avgGrp.all()[0].value.avg},"#avgGame","Average");numberContainer(function(){return totalGrp.all()[0].value.sum},"#totalScore","Total")}function updateAll(){updatePlayerChart();updateGameChart();updateCountryChart();updateGenderChart();updateDisciplineChart();updateHandChart();updateNumbers()}function gameReducer(group){group.reduce(function(p,v,n){var disc=v.Discipline;games.forEach(function(g){var k=disc+": "+g;if(!p[k])p[k]={count:0,sum:0,avg:0};if(+v[g]>0){++p[k].count;p[k].sum+=+v[g]||0;p[k].avg=p[k].sum/p[k].count||0}});return p},function(p,v){var disc=v.Discipline;games.forEach(function(g){var k=disc+": "+g;if(+v[g]>0){--p[k].count;p[k].sum-=+v[g]||0;p[k].avg=p[k].sum/p[k].count||0}});return p},function(){return{}});return group}function init(data){cf=(0,_crossfilter2.default)(data);cf.data=data;data.forEach(function(d){if(d.Block2==="-1"){d.G4=d.G1;d.G5=d.G2;d.G6=d.G3;d.G1="0";d.G2="0";d.G3="0"}});data.sort(function(a,b){return _d2.default.ascending(a.DisciplineOrder,b.DisciplineOrder)});playerDim=cf.dimension(function(d){return d.Playername});countryDim=cf.dimension(function(d){return d.Federation});genderDim=cf.dimension(function(d){return d.Gender});disciplineDim=cf.dimension(function(d){return d.Discipline});handDim=cf.dimension(function(d){return d.Hand});allDim=cf.dimension(function(d){return"all"});genderDim2=cf.dimension(function(d){return d.Gender});maxGrp=(0,_reductio2.default)().max(function(d){return _d2.default.max(games.map(function(g){return+d[g]||0}).filter(function(d){return d!==0}))})(allDim.group());minGrp=(0,_reductio2.default)().min(function(d){return _d2.default.min(games.map(function(g){return+d[g]||0}).filter(function(d){return d!==0}))})(allDim.group());totalGrp=(0,_reductio2.default)().sum(function(d){return _d2.default.sum(games.map(function(g){return+d[g]||0}))})(allDim.group());genderGameGrp=gameReducer(genderDim2.group());avgGrp=allDim.group().reduce(function(p,v){var _games=games.map(function(g){return+v[g]||0}).filter(function(d){return d!==0});p.count+=_games.length;p.sum+=_d2.default.sum(_games);p.avg=p.sum/p.count||0;return p},function(p,v){var _games=games.map(function(g){return+v[g]||0}).filter(function(d){return d!==0});p.count-=_games.length;p.sum-=_d2.default.sum(_games);p.avg=p.sum/p.count||0;return p},function(){return{count:0,sum:0,avg:0}});allGrp=gameReducer(allDim.group());gameGrp={all:function all(){var _all=allGrp.all()[0].value;return Object.keys(_all).map(function(k){return{key:k,value:_all[k]}})}};allAvg=gameGrp.all().map(function(d){return{key:d.key,value:{avg:d.value.avg}}});playerGrp=scoreReducer(playerDim.group());genderGrp=scoreReducer(genderDim.group());countryGrp=scoreReducer(countryDim.group());disciplineGrp=scoreReducer(disciplineDim.group());handGrp=scoreReducer(handDim.group());updateAll()}dsv("playerstats.csv",init);window.onload=function(){console.log("onload");document.getElementById("scrollTop").addEventListener("click",function(ev){ev.preventDefault();TweenLite.to(window,.75,{scrollTo:{y:0},ease:Power2.easeInOut})})}},{"./highcharts_theme":32,crossfilter2:2,d3:3,reductio:25}]},{},[33]);
...
function getLane(lane_number) {
  ...
  var endDate = new Date('2016-03-19T23:00:00');
...
},{"./lane":4,"./settings":6,"./store":7,"mithril":5}],3:[function(require,module,exports){
'use strict';
...
lane_component.controller = function (lane_number) {
  ...
  ctrl.addPlayers = function (players) {
    players.forEach(function (p) {
      return p.name = window.decodeURIComponent(p.name).replace(/\+/g, ' ');
    });
...
lane_component.view = function (ctrl) {
  ...
  ctrl.changed = false;
  return (0, _mithril2.default)('.lane-container', [(0, _mithril2.default)('.lane-name', ctrl.lane_number), players.map(function (p) {
    return _game2.default.view(p, function () {
...
},{"mithril":5}],7:[function(require,module,exports){
'use strict';
